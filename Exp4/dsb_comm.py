...
from power import power  # grc-generated hier_block



from gnuradio import qtgui

class dsb_comm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsb_comm")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/shay/a/ekocinar/ECE440/Lab4/audiotest2.wav', True)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_divide_xx_0 = blocks.divide_ff(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.audio_sink_0 = audio.sink(44100, 'plughw', True)
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.power_0, 0))
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.power_0_0, 0))
        ...
        self.connect((self.power_0, 0), (self.blocks_divide_xx_0, 1))
        self.connect((self.power_0_0, 0), (self.blocks_divide_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 40000, 100, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 200000, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=dsb_comm, options=None):
