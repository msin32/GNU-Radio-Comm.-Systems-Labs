...
class bpsk(gr.top_block):
    ...
    def __init__(self):
        ...
        self.filter_coeff = filter_coeff = [0.25, 0.25, 0.25, 0.25]
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc((6.28)/50, 2, False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/shay/a/ekocinar/ECE440/Lab7/rx_bpsk.txt', False)
